          ...
          >
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img
                        src="../../assets/AdminTemplate/images/faces/face4.jpg"
                        alt="image"
                        class="profile-pic"
                      />
                    </div>
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img
                        src="../../assets/AdminTemplate/images/faces/face2.jpg"
                        alt="image"
                        class="profile-pic"
                      />
                    </div>
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img
                        src="../../assets/AdminTemplate/images/faces/face3.jpg"
                        alt="image"
                        class="profile-pic"
                      />
                    </div>
            ...
            >
              <a class="navbar-brand brand-logo" href="index.html"
                ><img
                  src="../../assets/AdminTemplate/images/logo.svg"
                  alt="logo"
              /></a>
              <a class="navbar-brand brand-logo-mini" href="index.html"
                ><img
                  src="../../assets/AdminTemplate/images/logo-mini.svg"
                  alt="logo"
              /></a>
            </div>
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item nav-profile dropdown">
                <a
                  ...
                  id="profileDropdown"
                >
                  <span @click="logout" class="nav-profile-name" style="font-weight: bold; font-size: 20px; color: red;">Hello {{ name || "Admin" }}</span>
                  <span class="online-status"></span>
                  <img @click="logout" :src="imageSrc" alt="profile" />
                </a>
                <div
      ...
      <nav class="bottom-navbar">
        <div class="container">
          <ul class="nav page-navigation">
            ...
            <li class="nav-item">
              <a href="#" v-on:click="NextForm" class="nav-link">
            ...
            <li class="nav-item">
              <a href="#" v-on:click="NextChart" class="nav-link">
            ...
            <li class="nav-item">
              <a href="#" v-on:click="NextTable" class="nav-link">
...
export default {
  ...
  mounted(){
    const data = this.$store.getters.name
    if(data){
      this.name = data
    }
  }
  ...
  methods: {
    ...
    async logout(){
      await axios.get(this.hostname + `/api/Account/Logout?name=${this.name}`, this.getTokenConfig())
        .then(() => {
          this.ResetRole()
    ...
    NextForm() {
      this.$router.push({ name: "EditOrAdd" });
    },
    chuyenBase64ToImage(base64) {
      if(Array.isArray(base64)){
        let byteConverBase64 = this.ConvertByteTobase64(base64);
        this.imageSrc = `data:image/*;base64, ${byteConverBase64}`;
      }else{
    ...
    ConvertByteTobase64(byte) {
      if(Array.isArray(byte)){
        ...
        Swal.fire("Không phải mảng Byte")
      }
      
    }
  },
  created() {
    /* Nếu lưu ảnh vào "localStorage" thì lúc lấy ra không cần sử dụng "JSON.parse()", vì dữ liệu ảnh không phải là 1 đối tượng JSON hợp lệ 
		nên gắn thẳng đường dẫn từ "localStorage" vào thẻ "<img :src="">" luôn
	*/
    const base64s = JSON.parse(localStorage.getItem("image"))
    console.log(base64s);
    this.chuyenBase64ToImage(base64s);
  },
};
</script>
