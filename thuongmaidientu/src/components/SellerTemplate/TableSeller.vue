            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="../../assets/FromSeller/images/faces/face15.jpg" alt="">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="../../assets/FromSeller/images/logo-mini.svg" alt="logo" /></a>
          </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="../../assets/FromSeller/images/faces/face4.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="../../assets/FromSeller/images/faces/face2.jpg" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title" style="font-weight: bold; color: yellow; font-size: 30px;"> {{ shopName || "Chưa có Shop" }} </h3>
            ...
            <div class="row">
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p @click="Next('Add')" style="cursor: pointer;" class="card-description"> Add class <code>.table</code>
                    </p>
                    <div class="table-responsive">
                      <div>
                        <input type="text" v-model="valueE" @keyup="searchShop($event)" />
                      </div>
                      <table class="table">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          <tr v-for="(item, index) in Product" :key="index">
                            ...
                            <td style="color: red">{{ item.nameShop }}</td>
                            <td style="color: red">{{ item.description }}</td>
                            <td style="color: red">{{ item.click }}</td>
                            <td v-for="(itemc, indexc) in item.category" :key="indexc">
                              <div style="color: red">
                                <p v-if="indexc !== item.category.length -1 && indexc !== 0" style="margin-left: -500px; border: 1px solid black">{{ itemc }}, </p>
                                <p v-if="indexc !== item.category.length -1 && indexc === 0">{{ itemc }}, </p>
                                <p v-else style="margin-left: -60px;">{{ itemc }} </p>
                              </div>
                            </td>
                            <td >
                              <div style="width: 100px; display: flex; flex-wrap: wrap">
                                <div v-for="(itemI, indexI) in item.image" :key="indexI"><img :src="itemI" /></div>
                              </div>
                            </td>
                            <td>
                              <label @click="Next(item.id, 'Delete', 'Product')" style="margin-right: 10px" class="badge badge-danger">Delete</label>
                              <label @click="Next(item.id, 'Edit', 'Product')" class="badge badge-warning">Update</label>
                            </td>
                          </tr>
                          
                        </tbody>
                      </table>
                      <PagesTotal :page="page" :totalPage="totalPage" :valueE="valueE" @pageChange="FindAll" @pageSizeChange="changeReload"></PagesTotal>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <table class="table table-hover">
                        ...
                        <tbody>
                          <tr v-for="(item, index) in Donhang" :key="index">
                            ...
                            <td style="color: yellow">{{ item.product_name }}</td>
                            <td style="color: yellow">{{ item.product_id }}</td>
                            <td class="text-danger"> {{ item.price }} <i class="mdi mdi-arrow-down"></i></td>
                            <td style="color: yellow">{{ item.soluong }}</td>
                            <td style="color: yellow">{{ item.total }}</td>
                            <td style="color: yellow">{{ item.account }}</td>
                            
                            <td>
                              <div>
                                <select v-model="item.trangthai" @change="UpdateTrangThai(item.product_id, item.account, item.trangthai, index)">
                                  <option v-for="(items, indexs) in Status" :key="indexs" :value="indexs">{{ items }}</option>
                                </select>
                              </div>
                            </td>
                            <td>
                              <div >
                                <!-- Pending: 'Chờ xử lý',
                                    ...
                                    Rejected: 'Bị từ chối',
                                    ChuanBiHang: 'Đang chuẩn bị hàng',
                                    DangGiao: 'Đang giao',
                                    Done: 'Xong',
                                    Delete: 'Xóa' -->
                                <i v-if="item.trangthai === 'Pending'" class="fa fa-coffee" aria-hidden="true" style="font-size: 25px; color: goldenrod;"></i>
                                <i v-if="item.trangthai === 'Approved'" class="fa fa-check" aria-hidden="true" style="font-size: 25px; color: aquamarine;"></i>
                                <i v-if="item.trangthai === 'Rejected'" class="fa fa-times-circle" aria-hidden="true" style="font-size: 25px; color: red;animation: tuchoi 0.5s ease-in-out infinite;"></i>
                                <i v-if="item.trangthai === 'ChuanBiHang'" class="fa fa-shopping-basket" aria-hidden="true" style="font-size: 25px; color: aqua; animation: example 0.5s ease-in-out infinite;"></i>
                                <i v-if="item.trangthai === 'DangGiao'" class="fa fa-truck" aria-hidden="true" style="font-size: 25px; color: aqua; animation: danggiao 1.5s ease-in-out infinite;"></i>
                                <i v-if="item.trangthai === 'DangGiao'" class="fa-solid fa-smog" style="font-size: 25px; color: aqua;"></i>
                                <p :style="StyleCss(item.trangthai)">{{ item.view }}</p>
                              </div>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Sản phẩm được mua nhiều nhất</h4>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <tr v-for="(item, index) in DataByMax" :key="index">
                            <td class="py-1">
                              <img :src="'data:image/*;base64,' + item.account_image" alt="image" />
                            </td>
                            <td style="color: yellow;"> {{item.name}} </td>
                            <td>
                              <div class="progress">
                                <div v-if="item.soluong <= 5" class="progress-bar" role="progressbar" :style="'width:' + item.soluong + '%; background-color: red; color: yellow; font-weight: bold;'" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{{item.soluong}}%</div>
                                <div class="progress-bar" role="progressbar" :style="'width:' + item.soluong + '%;' + randomMau() + randomMauChu() + 'font-weight: bold;'" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">{{item.soluong}}%</div>
                              </div>
                            </td>
                            <td style="color: yellow;"> {{item.shop_name}} </td>
                            <td style="color: yellow;"> {{ item.productName }} </td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <tr v-for="(item, index) in accountByMax" :key="index">
                            <td class="py-1">
                              <img :src="'data:image/*;base64,' + item.account_image" alt="image" />
                            </td>
                            <td style="color: yellow;"> {{item.name}} </td>
                            <td>
                              <div class="progress" style="width: 500px">
                                <div v-if="tinhPhanTRamItem(item.soluong, 500) >= 100" class="progress-bar" role="progressbar" :style="'width: '+ tinhPhanTRamItem(item.soluong, 500) +'px;' + randomMau() + randomMauChu() + 'font-weight: bold;'" aria-valuenow="25" aria-valuemin="0" aria-valuemax="200">{{tinhPhanTRamItem(item.soluong, 500)}}% (Vượt chỉ tiêu)</div>
                                <div v-else-if="tinhPhanTRamItem(item.soluong, 500) < 100" class="progress-bar" role="progressbar" :style="'width: '+ tinhPhanTRamItem(item.soluong, 500) +'px;' + randomMau() + randomMauChu() + 'font-weight: bold;'" aria-valuenow="25" aria-valuemin="0" aria-valuemax="200">{{tinhPhanTRamItem(item.soluong, 500)}}%</div>
                                <div v-if="item.soluong <= 5" class="progress-bar" role="progressbar" :style="'width:' + tinhPhanTRamItem(item.soluong, 500) + '%; background-color: red; color: yellow; font-weight: bold;'" aria-valuenow="25" aria-valuemin="0" aria-valuemax="200">{{tinhPhanTRamItem(item.soluong, 500)}}%</div>

                              </div>
                            </td>
                            <td style="color: yellow;"> {{item.shop_name}} </td>
                            <td style="color: yellow;"> {{ item.productId_name }} </td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
import Swal from 'sweetalert2'
  export default{
    ...
    async created(){
      ...
      await this.FindAllDonHangChoXuLy("", "")
      await this.FindAllByMax()
      await this.FindAllProductByMax()
    },
    watch: {
      page: {
        handler: function change(){
          if(this.valueE === ""){
            ...
            this.FindAll([this.valueE, this.page])
          }
        },
        deep: true
      },
    ...
    mounted(){
      const name_shop = this.$store.getters.shop_name
      
      if(name_shop){
        this.shopName = name_shop
      }
      const thongbao = JSON.parse(localStorage.getItem('thongbao'))
      if(thongbao){
        this.$notify({
            title: thongbao.title,
            text: thongbao.text,
            // Hiển thị thông báo trong khoảng thời gian còn lại
            duration: thongbao.duration - (Date.now() - thongbao.timestamp),
            type: thongbao.type
          });

          // Xóa thông báo khỏi localStorage sau khi hiển thị xong, sử dụng hàm "setTimeout()"
          setTimeout(() => {
            localStorage.removeItem('thongbao')
          }, thongbao.duration - (Date.now() - thongbao.timestamp))
      }
    }
    ,
      methods:{
        ...
        tinhPhanTRamItem(total, phantram){
          console.log(phantram + " " + total)
          let pt = phantram / 100
          return total / pt
        }
        ,
        tingPhanTram(total, phantram){
          let phantramItam = phantram / 100
          this.accountByMax.forEach(item =>{
            total += (item.soluong / phantramItam)
          })
          console.log("Phần trăm: " + total)

        }
        ,
        async FindAllProductByMax(){
          console.log("Tên Shop" + this.$store.getters.shop_name)
          this.checkLoad = true
          const name = this.$store.getters.name
          console.log("Name: " + name)
          await axios.get(this.hostname + `/api/Order/FindAllAccountDonHangByMax?account_name=${name}&page=1&pageSize=20`)
          .then(response => {
            console.log(response)
            this.accountByMax = response.data.content.data
      ...
      ,
        randomMau() {
          ...
          return `background-color: ${this.danhSachMau[randomIndex]};`;
        },
        randomMauChu(){
        ...
        async FindAllByMax(){
          this.checkLoad = true
          const name = this.$store.getters.name
          await axios.get(this.hostname + `/api/Order/FindAllDonHangByMax?account_name=${name}&page=1&pageSize=20`)
            .then(response => {
              console.log(response)
              this.DataByMax = response.data.content.data
              this.checkLoad = false
            })
            .catch(error => {
              if(error.response){
        ...
        async UpdateTrangThai(id, account_name, trangthai, index){
          this.checkLoad = true
          console.log(id + " " + account_name + " " + trangthai + " " + index)
          const name = this.$store.getters.name
          const ListKey = Object.keys(this.Status)
          const KeyDone = ListKey.find(key => this.Status[key] === this.Status.Done) // Lấy ra "Key" trong Object "Status", theo điều kiện "Key" có "value" là "Xong"
          if(trangthai === KeyDone){
            await axios.put(this.hostname + `/api/Order/UpdateDonHangXuLy?product_id=${id}&name=${name}&accounty_name=${account_name}&status=${trangthai}`)
              .then(response => {
                
                console.log(response)
                this.FindAllDonHangChoXuLy("", index)
                this.FindAllByMax()
                this.checkLoad = false
                this.$notify({
                    title: "Thông báo",
            ...
            this.checkLoad = true
            await axios.put(this.hostname + `/api/Order/UpdateDonHangXuLy?product_id=${id}&name=${name}&status=${trangthai}`)
              .then(response => {
                console.log(response)
                this.FindAllByMax()
                if(trangthai === 'Pending'){
                  this.FindAllDonHangChoXuLy('Đang xác nhận đơn hàng', index)
                }else if(trangthai === 'Approved'){
                  this.FindAllDonHangChoXuLy('Chấp nhận đơn hàng', index)
                }else if(trangthai === 'Rejected'){
                  this.FindAllDonHangChoXuLy('Từ chối đơn hàng', index)
                }else if(trangthai === 'ChuanBiHang'){
                  this.FindAllDonHangChoXuLy('Đang chuẩn bị hàng', index)
                }else if(trangthai === 'DangGiao'){
                  this.FindAllDonHangChoXuLy('Đang giao hàng', index)
                }else{
                  this.FindAllDonHangChoXuLy('', '')
                }
                // this.FindAllDonHangChoXuLy('ABC', index)
                this.checkLoad = false
                this.$notify({
                    title: "Thông báo",
                    text: "Thành công",
        ...
        ,
        async FindAllDonHangChoXuLy(text, index){
          this.checkLoad = true
          const name = this.$store.getters.name
          console.log("Nam " + name)
          const res = await axios.get(this.hostname + `/api/Order/FindAllDonHangXuLy?name=${name}&page=1&pageSize=50`)
          this.dataDonhang = res.data.content.data

          console.log(res)

          const hasViewField = this.Donhang.some(item => 'view' in item);
          if(hasViewField){
            if(text !== '' && index >= 0){
              this.Donhang[index].view = text
            }
            if(index >= 0 && text === ''){
              this.Donhang.splice(index, 1)
            }
            this.checkLoad = false
          }else{
            this.checkLoad = true
          // Kiểm tra xem mảng có rỗng không
            if(!this.dataDonhang.length || this.dataDonhang === 0){ // Sử dụng "!this.dataDonhang.length || this.dataDonhang === 0" để kiểm tra xem mảng có rỗng không, "!this.dataDonhang.length" nghĩa là mảng không có độ dài kích thước(nghĩa là bị Null) và kích thước mảng là "0"
              // Nếu mảng rỗng thì hiển thị ra thông báo, và return
              this.$notify({
                title: "Thông báo",
            ...
            this.Donhang = this.dataDonhang.map(item => {
              return {...item, view: ''}
            })

            this.Donhang.map(item => {
              if(item.trangthai === 'Pending'){
                item.view = 'Đang xác nhận đơn hàng'
              }else if(item.trangthai === 'Rejected'){
                item.view = 'Từ chối đơn hàng'
              }else if(item.trangthai === 'ChuanBiHang'){
                item.view = 'Đang chuẩn bị hàng'
              }else if(item.trangthai === 'DangGiao'){
                item.view = 'Đang giao hàng'
              }else if(item.trangthai === 'Approved'){
                item.view = 'Chấp nhận đơn hàng'
              }
            })
          }
        ...
        ,
        async Next(id, type, table){
          if(id === 'Add'){
            this.checkLoad = false
            this.$router.push({name: "addedit", params:{type: id, table: id}})
          }
          //"typeof" được sử dụng khi cần kiểm tra kiểu dữ liệu của một biến trước khi thực hiện các hành động xử lý dữ liệu tương ứng.
          else if(typeof id !== 'undefined' && type === 'Edit' && table === "Product"){
            localStorage.setItem('IdProduct', JSON.stringify(id))
            this.$router.push({name: "addedit", params:{type: type, table: table}})

          }
          else if(typeof id !== 'undefined' && type === 'Delete' && table === "Product"){
            let ids = []
            ids.push(id)
            const idList = ids.join(', ')
            if(confirm("Bạn chắc chắn muốn xóa bản ghi này?")){
              await axios.delete(this.hostname + "/api/Product/DeleteProduct", {
                headers:{
                  'id': [idList]
                }
              }, this.getTokenConfig())
              .then(() => {
                ...
                this.$router.push({name: "tableSeller"})
              })
              .catch(error => {
                if(error.response){
                  Swal.fire(error.response.data)
      ...
      const name = this.$store.getters.name
        if(arr[0] === ""){
          this.checkLoad = true
          await axios.get(this.hostname + `/api/Product/FindAll?account_name=${name}&page=${arr[1]}&pageSize=${this.pageSize}`)
            .then(response =>{
              console.log(response);
              this.Product = response.data.content.data
              this.page = response.data.content.page
              this.totalPage = response.data.content.totalPages
          ...
          this.checkLoad = true
          await axios.get(this.hostname + `/api/Product/FindAll?name=${arr[0]}&account_name=${name}&page=${arr[1]}&pageSize=${this.pageSize}`)
            .then(response =>{
              console.log(response);
              this.Product = response.data.content.data
              this.page = response.data.content.page
...
<style scoped>
@import '@/assets/FromSeller/vendors/mdi/css/materialdesignicons.min.css';
    @import '@/assets/FromSeller/vendors/css/vendor.bundle.base.css';
    @import '@/assets/FromSeller/vendors/jvectormap/jquery-jvectormap.css';
    @import '@/assets/FromSeller/vendors/flag-icon-css/css/flag-icon.min.css';
    @import '@/assets/FromSeller/vendors/owl-carousel-2/owl.carousel.min.css';
    @import '@/assets/FromSeller/vendors/owl-carousel-2/owl.theme.default.min.css';
...
@font-face {
  font-family: 'Rubik';
  font-weight: 300;
  src: url("@/assets/FromSeller/fonts/Rubik/Rubik-Light.ttf");
  /* IE9 Compat Modes */ }

@font-face {
  font-family: 'Rubik';
  font-weight: 400;
  src: url("@/assets/FromSeller/fonts/Rubik/Rubik-Regular.ttf");
  /* IE9 Compat Modes */ }

@font-face {
  font-family: 'Rubik';
  font-weight: 500;
  src: url("@/assets/FromSeller/fonts/Rubik/Rubik-Medium.ttf");
  /* IE9 Compat Modes */ }

@font-face {
  font-family: 'Rubik';
  font-weight: 700;
  src: url("@/assets/FromSeller/fonts/Rubik/Rubik-Bold.ttf");
  /* IE9 Compat Modes */ }
...
/* Auth */
.auth.login-bg {
  background: url("@/assets/FromSeller/images/auth/Login_bg.jpg");
  background-size: cover; }

.auth .login-half-bg {
  background: url("@/assets/FromSeller/images/auth/login-bg.jpg");
  background-size: cover; }

.auth.register-half-bg {
  background: url("@/assets/FromSeller/images/auth/Login_bg2.jpg");
  background-size: cover; }

.auth.lock-full-bg {
  background: url("@/assets/FromSeller/images/auth/lockscreen-bg.jpg");
  background-size: cover; }
