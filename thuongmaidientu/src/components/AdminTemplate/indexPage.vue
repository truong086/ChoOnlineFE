        ...
        >
          <div class="ps-lg-1">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <a
                href="https://www.bootstrapdash.com/product/kapella-admin-pro/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo"
                target="_blank"
          ...
          <div class="d-flex align-items-center justify-content-between">
            <a href="https://www.bootstrapdash.com/product/kapella-admin-pro/"
            ...
            <div class="col-lg-4 mb-3 mb-lg-0">
              <div class="card congratulation-bg text-center">
                <div class="card-body pb-0">
                  <img
                    src="../../assets/AdminTemplate/images/dashboard/face29.png"
                    alt=""
                  />
                    ...
                    <div class="card-body">
                      ...
                      <div>
                        ...
                        >
                          <li class="nav-item">
                            <a
                              class="nav-link active ps-2 pe-2"
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="position-relative">
                            <img
                              src="../../assets/AdminTemplate/images/dashboard/live.png"
                              class="w-100"
                              alt=""
                            />
                ...
                <div class="card-body">
                  ...
                  >
                    ...
                    <h4 class="text-success font-weight-bold">
                      Tickets<span class="text-dark ms-3">163</span>
                    </h4>
                  </div>
                  <div
...
import Headerpages1 from '../Header/HeaderPage.vue'
